    ...
    <div class="mb-4">
        ...
        <div class="d-flex flex-wrap gap-3">
            ...
            <div class="text-center" style="width: 130px">
                ...
                <button type="button" class="btn btn-outline-danger btn-sm w-100 btn-excluir-imagem"
                    data-imagem-id="{{ $imagem->id }}" data-filme-id="{{ $filme->id }}">
                    Remover
                </button>
...
<script>
    ...
    document.getElementById('btn-vincular').addEventListener('click', () => {
        ...
        container_pessoa.appendChild(card);
        indice_pessoa++;
    });
    ...
    document.querySelectorAll('.btn-excluir-imagem').forEach(botao => {
    botao.addEventListener('click', () => {
        ...
        // Cria o formulário na hora, fora do form principal
        const form = document.createElement('form');
        form.method = 'POST';
        form.action = `/imagens/${imagemId}/filme/${filmeId}`;
